    ...
    <table class="table table-condensed table-hover">
        ...
        <tr>
            @foreach($orders as $key => $value)
                <th>
                    <a href="{{ route('notification').'/manage?wd='.$wd.'&sort='.$key.'&by='.$value['by'] }}">{{ $value['name'] }}</a>
                </th>
            @endforeach
            <th></th>
        </tr>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="text-align: center;">
                                部分未读名单(前50人):
                                <a class="btn btn-warning" href="" target="_blank" id="modal_download"
                                   style="color:white;text-decoration: none;">统计表下载 [Excel]</a>
                            </h3>
                        </div>

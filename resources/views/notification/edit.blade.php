                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="time" type="text" class="form-control flatpickr flatpickr-input"
                                           ...
                                           value="{{ $notification->start_time && $notification->end_time? $notification->start_time.' to '.$notification->end_time :'' }}"
                                           autocomplete="off">
                            ...
                            <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                                <div class="col-md-10 col-md-offset-1">
                                    <script id="container" name="content"
                                            type="text/plain">{!! $notification->content !!}</script>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="panel panel-success">
                                        ...
                                        <div id="filesContainer"
                                            ...
                                            {!! \App\Http\Controllers\NotificationController::insertFile($notification->files,true) !!}
                                            @if ($errors->has('files'))
                                                <span class="help-block">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="important"
                                                   autocomplete="off" {{ $notification->important?'checked':'' }}>
                                            这是重要通知（要求仔细阅读）
                                        </label>
                                    </div>
                                </div>

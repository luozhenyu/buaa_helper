...
<style>
    ...
    @media (min-width: 992px) {
        #back_div {
            background: url(/img/bk2.jpg) -80px -280px;
    ...
    @media (max-width: 991px) and (min-width: 768px) {
        #back_div {
            background: url(/img/bk2.jpg) -600px -200px;
            background-size: 1600px;
        }
    }
    @media (max-width: 767px) {
        #back_div {
            background: url(/img/bk2.jpg) -800px -200px;
            background-size: 1600px;
        }
    }
...
<script>
    $(function(){
        $(document).ready(function(){
            setTimeout(function(){ $("#back_div").fadeTo(800, 1); },1);

            setTimeout(function(){ $("#title_one").fadeTo(320,1); },450);
            setTimeout(function(){ $("#title_two").fadeTo(320,1); },700);
            setTimeout(function(){ $("#back_div").fadeTo(640,0.65); },950);
            setTimeout(function(){ $("#btn_area").fadeTo(400,1); },1150);
        });
    })
</script>
@endpush
